...
vagrant_files_dir = File.join( vagrant_dir, "vm" );
puts "Vagrant files located at: " + vagrant_files_dir;
...
Vagrant.configure("2") do |config|
  ...
  #
  config.vm.network :private_network, id: "vvv_primary", ip: "192.168.56.74"
